 ...
 * @author iychoi
 */
public class LibraCmdArgs extends CommandArgumentsBase {
    ...
    protected double stddevFactor = LibraConfig.DEFAULT_STANDARD_DEVIATION_FACTOR;
    ...
    private String outputPath = LibraConfig.DEFAULT_OUTPUT_PATH;
    ...
    public LibraConfig getLibraConfig() {
        LibraConfig config = new LibraConfig();
