 ...
 * @author iychoi
 */
public abstract class AKmerIndexRecordFilter {
    public abstract CompressedIntArrayWritable accept(CompressedSequenceWritable key, CompressedIntArrayWritable value);
}
